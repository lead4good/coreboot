...
static const struct pad_config gpio_table[] = {
	...
	PAD_NC(GPP_B18, UP_20K), // LPSS_GSPI_MOSI (test point)
	...
	PAD_NC(GPP_G6, UP_20K), // Test point
	...
	PAD_NC(GPP_H13, NONE), // 100k pull up
	PAD_NC(GPP_H14, UP_20K),
	PAD_NC(GPP_H15, NONE), // 20k pull up
	PAD_CFG_TERM_GPO(GPP_H16, 1, NONE, RSMRST), // TBT_RTD3_PWR_EN_R
	...
	/* ------- GPIO Group GPP_J ------- */
	PAD_NC(GPP_J0, UP_20K), // XXX: CNVI_GNSS_PA_BLANKING?
	...
	PAD_NC(GPP_J9, NONE), // 100k pull up, 100k pull down
	PAD_NC(GPP_J10, NONE), // 100k pull down
